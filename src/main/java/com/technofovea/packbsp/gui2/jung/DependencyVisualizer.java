 ...
 * @author Darien Hager
 */
public class DependencyVisualizer extends BasicVisualizationServer<Node, Edge> {
    ...
    public DependencyVisualizer(Layout<Node, Edge> layout, Dimension preferredSize) {
